...
export const JobMainContainer = ({ highlight, title, desc }: props) => {
    return (
        ...
        <div className="relative w-ful h-[600px] bg-cover bg-center" style={{ backgroundImage: `url(${cover.src})` }}>
            <div className='max-w-7xl mx-auto my-4 md:my-6 px-2 md:px-4 relative z-10'>
                {/* Content section */}
                <div className='text-center'>
                    <p className="text-sm md:text-base lg:text-lg text-primary -mb-2 md:mb-1 lg:mb-2">{highlight}</p>
                    <h2 className="text-lg md:text-2xl lg:text-4xl font-bold m-2 md:mb-3 lg:mb-5 text-textprimary ">{title}</h2>
            ...
            {/* Add a semi-transparent overlay to ensure readability of text on the background */}
            {/* <div className='absolute top-0 left-0 right-0 bottom-0 bg-black opacity-40 z-0' /> */}
        </div>
