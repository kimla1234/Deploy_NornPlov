      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mt-4 ">
          ...
          <div className="flex justify-start md:justify-center lg:justify-center ">
            <div>
              <h3 className="font-semibold lg:text-2xl md:text-2xl text-xl mb-4 text-textprimary">
                មាតិការ
              </h3>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">លេខ ទូរស័ព្ទ</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-textprimary">ផ្ទះលេខ ២៤ ផ្លូវ ៥៦២ សង្កាត់បឹងកក់ ១ ខណ្ឌទួលគោក រាជធានីភ្នំពេញ</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Copyright */}
        <div className="mt-8 pt-4 border-t text-sm text-center text-textprimary">
          <p>
