...
import quizQuestions from '@/src/app/(user)/json/interestKh.json';
...
export const InterestTest = () => {
    ...
    const totalQuestions = 12; // Number of questions in your quiz
    ...
    const { interestTestintroKh } = interestJson
    ...
    return (
        <div className='w-full'>
            ...
            <div className='bg-bgPrimaryLight pb-6'>
                ...
                <QuizIntroContainer
                    introTitle={interestTestintroKh.title}
                    introHightlight={interestTestintroKh.highlight}
                    introDesc={interestTestintroKh.description}
            ...
            <div className='max-w-7xl mx-auto px-4 py-6 flex gap-2 justify-end'>
                ...
                <QuizButton title={quizButtonKh.result} rounded='xl' icon={<ArrowRight />} type='rightIcon' onClick={() => handleResultClick('interest-test-result')} />
