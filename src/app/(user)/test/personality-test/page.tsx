...
import quizQuestions from '@/src/app/(user)/json/personalityKh.json';
    ...
    return (
        <div className='w-full'>
            ...
            <div className='bg-bgPrimaryLight pb-6'>
                ...
                <QuizIntroContainer
                    introTitle={personalityTestintroKh.title}
                    introHightlight={personalityTestintroKh.highlight}
                    introDesc={personalityTestintroKh.description}
            ...
            <div className='max-w-7xl mx-auto px-4 py-6 flex gap-2 justify-end'>
                ...
                <QuizButton title={quizButtonKh.result} rounded='xl' icon={<ArrowRight />} type='rightIcon' onClick={() => handleResultClick('personality-test-result')} />
