...
import quizQuestions from '@/src/app/(user)/json/learningStyleKh.json';
...
export default function LearningStyleTest() {
    ...
    const totalQuestions = 8; // Number of questions in your quiz
    ...
    const { learningStyleTestintroKh } = learningStyleJson
    ...
    return (
        <div className='w-full'>
            ...
            <div className='bg-bgPrimaryLight pb-6'>
                ...
                <QuizIntroContainer
                    introTitle={learningStyleTestintroKh.title}
                    introHightlight={learningStyleTestintroKh.highlight}
                    introDesc={learningStyleTestintroKh.description}
            ...
            <div className='max-w-7xl mx-auto px-4 py-6 flex gap-2 justify-end'>
                ...
                <QuizButton title={quizButtonKh.result} rounded='xl' icon={<ArrowRight />} type='rightIcon' onClick={() => handleResultClick('learning-style-test-result')} />
