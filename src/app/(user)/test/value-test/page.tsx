...
import quizQuestions from '@/src/app/(user)/json/valueKh.json';
...
export default function ValueTest() {
    ...
    const { valueTestintroKh } = valueJson
    ...
    return (
        <div className='w-full'>
            ...
            <div className='bg-bgPrimaryLight pb-6'>
                ...
                <QuizIntroContainer
                    introTitle={valueTestintroKh.title}
                    introHightlight={valueTestintroKh.highlight}
                    introDesc={valueTestintroKh.description}
            ...
            <div className='max-w-7xl mx-auto px-4 py-6 flex gap-2 justify-end'>
                ...
                <QuizButton title={quizButtonKh.result} rounded='xl' icon={<ArrowRight />} type='rightIcon' onClick={() => handleResultClick('value-test-result')} />
